...
/**
* 进店客流天明细表
* @TableName customer_entering_store_day_detail
*/
@Data
@TableName(value ="customer_entering_store_day_detail")
public class CustomerEnteringStoreDayDetailDO implements Serializable {
