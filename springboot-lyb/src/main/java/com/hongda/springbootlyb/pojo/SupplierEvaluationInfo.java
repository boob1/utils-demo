 ...
 */
@Entity
@Table(name = "T_SUPPLIEREVALUATIONINFO")
public class SupplierEvaluationInfo {
  ...
  public Integer getSUPPLIEREVALUATIONINFO_ID() {
    return SUPPLIEREVALUATIONINFO_ID;
  }

  public void setSUPPLIEREVALUATIONINFO_ID(Integer SUPPLIEREVALUATIONINFO_ID) {
    this.SUPPLIEREVALUATIONINFO_ID = SUPPLIEREVALUATIONINFO_ID;
  }
  ...
  public String getSUPPLIEREVALUATIONINFO_DESC() {
    return SUPPLIEREVALUATIONINFO_DESC;
  }

  public void setSUPPLIEREVALUATIONINFO_DESC(String SUPPLIEREVALUATIONINFO_DESC) {
    this.SUPPLIEREVALUATIONINFO_DESC = SUPPLIEREVALUATIONINFO_DESC;
  }
}
